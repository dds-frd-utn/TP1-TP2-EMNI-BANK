...
import utn.frd.emniapp.entities.InversionFacade;
...
public class InversionRest {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Path("/{id}")
    public void edit(@PathParam("id")int id, Inversion inversion){
        ejbInversionFacade.edit(inversion);
    }
    ...
    public void remove(@PathParam("id")int id){
        ejbInversionFacade.remove( ejbInversionFacade.find(id) );
    }
    ...
    @Path("/{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Inversion findById(@PathParam("id")int id){
        return ejbInversionFacade.find(id);
    }
}
